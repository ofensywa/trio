...
#include "..\SDK\IEngineTrace.h" //Has some structs we need here
...
{
public:
	studiohdr_t* GetStudiomodel2(const model_t* mod)
	{
		return Utils::CallVFunc<32, studiohdr_t*>(this, mod);
	}

	void GetModelMaterials2(const model_t *model, int count, IMaterial** ppMaterial)
	{
		typedef void *(__thiscall* oGetModelMaterials)(PVOID, const model_t*, int, IMaterial**);
		return  Utils::CallVFunc<19, void>(this, model, count, ppMaterial);
	}
};
